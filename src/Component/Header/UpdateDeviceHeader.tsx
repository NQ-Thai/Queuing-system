...
import UpdateContent from '../../pages/Device/UpdateContent';
                ...
                <div style={{ width: '1240px', height: '88px', marginBottom: '5px' }}>
                    ...
                    >
                        <span>
                            ...
                            <span className="text-add-header-content">&nbsp;&nbsp;Cập nhật thiết bị</span>
                        </span>
                        <div className="icon-wrapper-thietbi-update" style={{ display: 'inline-block', verticalAlign: 'middle' }}>
                            {iconBell}
                        </div>
...
export default UpdateDeviceHeader;
