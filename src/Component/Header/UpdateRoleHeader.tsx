...
import UpdateContent from '../../pages/Role/UpdateContent';
                    ...
                    >
                        <span>
                            ...
                            <Link to={'/quanlyvaitro'}>
                                <span className="text-first-head">Quản lý vai trò&nbsp;&nbsp;&gt;</span>
                            </Link>

                            <span className="text-add-header-content">&nbsp;&nbsp;Cập nhật vai trò</span>
                        </span>
                        <div className="icon-wrapper-vaitro-update" style={{ display: 'inline-block', verticalAlign: 'middle' }}>
                            {iconBell}
                        </div>
...
export default UpdateRoleHeader;
