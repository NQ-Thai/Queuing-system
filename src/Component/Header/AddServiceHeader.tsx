...
import AddContent from '../../pages/Service/AddContent';
                ...
                <div style={{ width: '1240px', height: '88px', marginBottom: '5px' }}>
                    ...
                    >
                        <span>
                            ...
                            <span className="text-add-header-content">&nbsp;&nbsp;Thêm dịch vụ</span>
                        </span>
                        <div className="icon-wrapper-dichvu-add" style={{ display: 'inline-block', verticalAlign: 'middle' }}>
                            {iconBell}
                        </div>
