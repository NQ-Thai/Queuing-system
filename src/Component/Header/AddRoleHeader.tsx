...
import AddContent from '../../pages/Role/AddContent';
                ...
                <div style={{ width: '1240px', height: '88px', marginBottom: '5px' }}>
                    ...
                    >
                        <span>
                            ...
                            <span className="text-add-header-content">&nbsp;&nbsp;Thêm vai trò</span>
                        </span>
                        <div className="icon-wrapper-vaitro-add" style={{ display: 'inline-block', verticalAlign: 'middle' }}>
                            {iconBell}
                        </div>
