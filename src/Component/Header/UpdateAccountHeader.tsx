...
import UpdateContent from '../../pages/Account/UpdateContent';
                ...
                <div style={{ width: '1240px', height: '88px', marginBottom: '5px' }}>
                    ...
                    >
                        <span>
                            ...
                            <span className="text-add-header-content">&nbsp;&nbsp;Cập nhật tài khoản</span>
                        </span>
                        <div className="icon-wrapper-taikhoan-update" style={{ display: 'inline-block', verticalAlign: 'middle' }}>
                            {iconBell}
                        </div>
