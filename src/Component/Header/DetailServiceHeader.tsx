...
import DetailContentDichVu from '../../pages/Service/DetailContent';

function DetailServiceHeader() {
            ...
            <Layout>
                <div style={{ width: '1240px', height: '88px', marginBottom: '5px' }}>
                    ...
                    >
                        ...
                        <div className="icon-wrapper-dichvu-detail" style={{ display: 'inline-block', verticalAlign: 'middle' }}>
                            {iconBell}
                        </div>
...
export default DetailServiceHeader;
