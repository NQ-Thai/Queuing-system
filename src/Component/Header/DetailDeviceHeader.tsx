...
import ChiTietContent from '../../pages/Device/DetailDevice';

function DetailDeviceHeader() {
                ...
                <div style={{ width: '1240px', height: '88px', marginBottom: '5px' }}>
                    ...
                    >
                        <span>
                            ...
                            <span className="text-add-header-content">&nbsp;&nbsp;Chi tiết thiết bị</span>
                        </span>
                        <div className="icon-wrapper-thietbi-detail" style={{ display: 'inline-block', verticalAlign: 'middle' }}>
                            {iconBell}
                        </div>
