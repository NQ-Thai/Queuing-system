...
function AddContent() {
    ...
    const trangThaiHoatDongOptions = ['Hoạt động', 'Ngưng hoạt động'];

    const handleSave = async () => {
        const trangThaiHoatDongRandomIndex = Math.floor(Math.random() * trangThaiHoatDongOptions.length);
        const trangThaiHoatDongRandom = trangThaiHoatDongOptions[trangThaiHoatDongRandomIndex];
        ...
        try {
            ...
            await addDoc(collection(firestore, 'dichvu'), {
                ...
                TenDichVu: tenDichVu,
                MoTa: moTa,
                TrangThaiHoatDong: trangThaiHoatDongRandom,
                Date: currentDate,
            });
            ...
            await addDoc(collection(firestore, 'nhatky'), {
                ...
                ThaoTac: 'Thêm dịch vụ có mã là ' + maDichVu,
                ThoiGian: thoiGian,
            });
